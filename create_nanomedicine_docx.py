...
MD_FILE = '/projects/sandbox/AMMAN/Chapter_AI_Nanomedicine_Smart_Drug_Delivery.md'
DOCX_FILE = '/projects/sandbox/AMMAN/Chapter_AI_Nanomedicine_Smart_Drug_Delivery.docx'
FIG_DIR = '/projects/sandbox/AMMAN/nanomedicine_figures'

# Map figure number -> image filename
FIGURE_FILES = {
    1: 'Figure_1_Nanocarrier_Platforms.png',
    2: 'Figure_2_ML_Workflow.png',
    3: 'Figure_3_Stimuli_Responsive.png',
    4: 'Figure_4_Closed_Loop_Theranostic.png',
}
