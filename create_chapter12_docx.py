...
References are in numbered sequential [1]-[43] format, ordered by first appearance in text.
No citations in abstract or conclusion sections.
"""
...
def create_chapter12_docx():
    ...
    paragraphs_1_3 = [
        ...
        "Standardization of microbial-derived bio-nanomaterials presents unique challenges compared to chemically synthesized counterparts due to the inherent biological variability in production processes. The establishment of reference standards, validated analytical methods, and harmonized testing protocols is essential for ensuring comparability between products from different manufacturers and for supporting regulatory submissions [15]. International standardization bodies including ISO, ASTM, and OECD have developed guidelines for nanomaterial characterization and testing, but specific standards for bio-nanomaterials remain limited and require further development. The creation of certified reference materials specifically for bio-nanomaterials, encompassing both physicochemical properties and biological activity measures, would substantially advance the field by providing common benchmarks against which production quality can be assessed."
    ]
    ...
    paragraphs_3_3 = [
        ...
        "Agricultural applications encompass nanofertilizers, nanopesticides, plant growth stimulants, and precision agriculture tools. The need for sustainable intensification of agricultural production to meet growing food demand while minimizing environmental impact drives interest in nanotechnology-based solutions [39]. Bio-nanomaterials produced by soil-associated microorganisms may offer particular advantages for agricultural applications due to their inherent compatibility with soil ecosystems. The development of slow-release nanofertilizer formulations that improve nutrient use efficiency while reducing runoff and groundwater contamination represents a particularly attractive value proposition for the agricultural market.",
    ...
    # ========================
    # REFERENCES (Numbered sequentially [1]-[43] by order of first appearance)
    # ========================
    doc.add_heading('References', level=1)
    
    references = [
        "[1] Narayanan, K. B., & Sakthivel, N. (2010). Biological synthesis of metal nanoparticles by microbes. Advances in Colloid and Interface Science, 156(1–2), 1–13.",
        ...
        "[3] Khandel, P., Yadaw, R. K., Soni, D. K., Kanwar, L., & Shahi, S. K. (2018). Biogenesis of metal nanoparticles and their pharmacological applications: Present status and application prospects. Journal of Nanostructure in Chemistry, 8(3), 217–254.",
        ...
        "[5] Gahlawat, G., & Choudhury, A. R. (2019). A review on the biosynthesis of metal and metal salt nanoparticles by microbes. RSC Advances, 9(23), 12944–12967.",
        ...
        "[7] Li, X., Xu, H., Chen, Z. S., & Chen, G. (2011). Biosynthesis of nanoparticles by microorganisms and their applications. Journal of Nanomaterials, 2011, 270974.",
        "[8] Rautela, A., Rani, J., & Debnath, M. (2019). Green synthesis of silver nanoparticles from Tectona grandis seeds extract: Characterization and mechanism of antimicrobial action. Journal of Analytical Science and Technology, 10(1), 5.",
        "[9] Saklani, V., Suman, J. V. K., & Jain, K. (2012). Microbial synthesis of silver nanoparticles: A review. Journal of Biotechnology and Biomaterials, S13, 007.",
        "[10] Moghaddam, A. B., Namvar, F., Moniri, M., Tahir, P. M., Azizi, S., & Mohamad, R. (2015). Nanoparticles biosynthesized by fungi and yeast: A review of their preparation, properties, and medical applications. Molecules, 20(9), 16540–16565.",
        "[11] Iravani, S. (2014). Bacteria in nanoparticle synthesis: Current status and future prospects. International Scholarly Research Notices, 2014, 359316.",
        "[12] Duan, H., Wang, D., & Li, Y. (2015). Green chemistry for nanoparticle synthesis. Chemical Society Reviews, 44(16), 5778–5792.",
        "[13] Kuppusamy, P., Yusoff, M. M., Maniam, G. P., & Govindan, N. (2016). Biosynthesis of metallic nanoparticles using plant derivatives and their new avenues in pharmacological applications. Saudi Pharmaceutical Journal, 24(4), 473–484.",
        "[14] Shah, M., Fawcett, D., Sharma, S., Tripathy, S. K., & Poinern, G. E. J. (2015). Green synthesis of metallic nanoparticles via biological entities. Materials, 8(11), 7278–7308.",
        "[15] Thakkar, K. N., Mhatre, S. S., & Parikh, R. Y. (2010). Biological synthesis of metallic nanoparticles. Nanomedicine: Nanotechnology, Biology and Medicine, 6(2), 257–262.",
        "[16] Bondarenko, O., Juganson, K., Ivask, A., Kasemets, K., Mortimer, M., & Kahru, A. (2013). Toxicity of Ag, CuO and ZnO nanoparticles to selected environmentally relevant test organisms and mammalian cells in vitro: A critical review. Archives of Toxicology, 87(7), 1181–1200.",
        "[17] Rasmussen, K., Rauscher, H., Mech, A., Riego Sintes, J., Gilliland, D., González, M., & Rossi, F. (2018). Physico-chemical properties of manufactured nanomaterials—Characterisation and relevant methods. European Commission.",
        "[18] Jeevanandam, J., Barhoum, A., Chan, Y. S., Dufresne, A., & Danquah, M. K. (2018). Review on nanoparticles and nanostructured materials: History, sources, toxicity and regulations. Beilstein Journal of Nanotechnology, 9, 1050–1074.",
        "[19] Ahmad, A., Mukherjee, P., Senapati, S., Mandal, D., Khan, M. I., Kumar, R., & Sastry, M. (2019). Extracellular biosynthesis of silver nanoparticles using the fungus Fusarium oxysporum. Colloids and Surfaces B: Biointerfaces, 28(4), 313–318.",
        "[20] Dwivedi, A. D., Dubey, S. P., Sillanpää, M., Kwon, Y. N., Lee, C., & Varma, R. S. (2015). Fate of engineered nanoparticles: Implications in the environment. Coordination Chemistry Reviews, 287, 64–78.",
        "[21] Nel, A. E., Nasser, E., Godwin, H., Avery, D., Bahadori, T., Bergeson, L., & Bhatt, I. (2013). A multi-stakeholder perspective on the use of alternative test strategies for nanomaterial safety assessment. ACS Nano, 7(8), 6422–6433.",
        "[22] Monopoli, M. P., Åberg, C., Salvati, A., & Dawson, K. A. (2012). Biomolecular coronas provide the biological identity of nanosized materials. Nature Nanotechnology, 7(12), 779–786.",
        "[23] Bundschuh, M., Filser, J., Lüderwald, S., McKee, M. S., Konold, G., & Wagner, S. (2018). Nanoparticles in the environment: Where do we come from, where do we go to? Environmental Sciences Europe, 30(1), 1–17.",
        "[24] Grieger, K. D., Linkov, I., Hansen, S. F., & Baun, A. (2012). Environmental risk analysis for nanomaterials: Review and evaluation of frameworks. Nanotoxicology, 6(2), 196–212.",
        "[25] Dhillon, G. S., Brar, S. K., Kaur, S., & Verma, M. (2012). Green approach for nanoparticle biosynthesis by fungi: Current trends and applications. Critical Reviews in Biotechnology, 32(1), 49–73.",
        "[26] Tripathi, D. K., Shweta, S. S., Prasad, S. M., & Chauhan, D. K. (2017). Silicon nanoparticles more efficiently alleviated UV-B stress than silicon in wheat seedlings. Plant Physiology and Biochemistry, 110, 70–81.",
        "[27] Mughal, B., Zaidi, S. Z. J., Zhang, X., & Hassan, S. U. (2021). Biogenic nanoparticles: Synthesis, characterisation and applications. Applied Sciences, 11(6), 2598.",
        "[28] Adir, O., Poley, M., Chen, G., Frober, S., Shklover, J., Shainsky-Roitman, J., & Schroeder, A. (2020). Integrating artificial intelligence and nanotechnology for precision cancer medicine. Advanced Materials, 32(13), 1901989.",
        "[29] Patel, S., Patel, P., & Bakshi, S. R. (2022). Machine learning-assisted design of nanomaterials. In Handbook of Nanomaterials (pp. 1–24). Springer.",
        "[30] Brown, K. A., Brittman, S., Maccaferri, N., Jarber, D., & Celano, U. (2020). Machine learning in nanoscience: Big data at small scales. Nano Letters, 20(1), 2–10.",
        "[31] Ge, M., Cao, C., Huang, J., Li, S., Chen, Z., Zhang, K. Q., & Lai, Y. (2020). A review of one-dimensional TiO2 nanostructured materials for environmental and energy applications. Journal of Materials Chemistry A, 4(18), 6772–6801.",
        "[32] Winkler, D. A. (2016). Recent advances, and unresolved issues, in the application of computational modelling to the prediction of the biological effects of nanomaterials. Toxicology and Applied Pharmacology, 299, 96–100.",
        "[33] Smiatek, J., Jung, A., & Bluhmki, E. (2020). Towards a digital bioprocess replica: Computational approaches in biopharmaceutical development and manufacturing. Trends in Biotechnology, 38(10), 1141–1153.",
        "[34] Zhang, J., Petersen, S. D., Radivojevic, T., Ramirez, A., Pérez-Manrique, A., Abeliuk, E., & Experiment, M. (2020). Combining mechanistic and machine learning models for predictive engineering and optimization of tryptophan metabolism. Nature Communications, 11(1), 4880.",
        "[35] Udugama, I. A., Gargalo, C. L., Yamashita, Y., Jørgensen, M. S., Gernaey, K. V., & Sin, G. (2021). Digital twin in biomanufacturing: Challenges and opportunities towards its implementation. Systems Microbiology and Biomanufacturing, 1(3), 257–274.",
        "[36] Pandey, G. (2021). Prospects of nanobioremediation in environmental cleanup. Oriental Journal of Chemistry, 34(6), 2838–2847.",
        "[37] Saravanan, M., Barabadi, H., Ramachandran, B., Venkatraman, G., & Ponmurugan, K. (2021). Emerging plant-based anti-cancer green nanomaterials in present scenario. In Comprehensive Analytical Chemistry (Vol. 87, pp. 291–318). Elsevier.",
        "[38] Vázquez-Núñez, E., Molina-Guerrero, C. E., Peña-Castro, J. M., Fernández-Luqueño, F., & de la Rosa-Álvarez, M. G. (2020). Use of nanotechnology for the bioremediation of contaminants: A review. Processes, 8(7), 826.",
        "[39] Kah, M., Tufenkji, N., & White, J. C. (2019). Nano-enabled strategies to enhance crop nutrition and protection. Nature Nanotechnology, 14(6), 532–540.",
        "[40] Rana, A., Yadav, K., & Jagadevan, S. (2020). A comprehensive review on green synthesis of nature-inspired metal nanoparticles: Mechanism, application and toxicity. Journal of Cleaner Production, 272, 122880.",
        "[41] Sharma, D., Kanchi, S., & Bisetty, K. (2019). Biogenic synthesis of nanoparticles: A review. Arabian Journal of Chemistry, 12(8), 3576–3600.",
        "[42] Guilger-Casagrande, M., & Lima, R. (2019). Synthesis of silver nanoparticles mediated by fungi: A review. Frontiers in Bioengineering and Biotechnology, 7, 287.",
        "[43] Li, Y., Li, Z., Gao, Y., & Gong, A. (2020). Microbial synthesis of functional metal nanomaterials: Mechanisms, progress, and future directions. Biotechnology Advances, 45, 107616.",
    ]
