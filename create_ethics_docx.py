...
Formatting complies with the editorial requirements: Times New Roman, 12-point
font, 1.5 line spacing (set in the styles docDefaults), no bullet points.

Usage:
    python3 create_ethics_docx.py
"""
...
MD_FILE = '/projects/sandbox/AMMAN/Chapter_Responsible_Innovation_Ethical_AI.md'
DOCX_FILE = '/projects/sandbox/AMMAN/Chapter_Responsible_Innovation_Ethical_AI.docx'
FIG_DIR = '/projects/sandbox/AMMAN/ethics_figures'

# Map figure number -> image filename
FIGURE_FILES = {
    1: 'Figure_1_RI_Dimensions.png',
    2: 'Figure_2_Ethical_Principles.png',
    3: 'Figure_3_Governance_Model.png',
    4: 'Figure_4_Stakeholder_Ecosystem.png',
}
