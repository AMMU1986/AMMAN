#!/usr/bin/env python3
"""
Create a downloadable Word .docx for Chapter 16
"Wearable, Implantable, and Intelligent Therapeutic Systems".

Uses raw OOXML (python-docx is unavailable in this sandbox) and embeds the
generated PNG figures inline at each "[Insert Figure 16.N here]" placeholder.
The Abstract paragraph is rendered with the Abstract style; markdown tables are
rendered as bordered Word tables.
"""
...
MD_FILE = '/projects/sandbox/AMMAN/Chapter_16_Wearable_Implantable_Intelligent_Therapeutic_Systems.md'
DOCX_FILE = '/projects/sandbox/AMMAN/Chapter_16_Wearable_Implantable_Intelligent_Therapeutic_Systems.docx'
FIG_DIR = '/projects/sandbox/AMMAN/wearable_figures'

# Map figure number -> image filename
FIGURE_FILES = {
    1: 'Figure_16_1_Wearable_Pipeline.png',
    2: 'Figure_16_2_Drug_Delivery.png',
    3: 'Figure_16_3_Closed_Loop.png',
    4: 'Figure_16_4_Convergence.png',
}
...
FIG_PLACEHOLDER = re.compile(r'\[Insert Figure 16\.(\d+) here\]')
...
def md_to_body(md_text, image_rels):
    ...
    while i < len(lines):
        ...
        # Figure caption line
        if line.strip().startswith('Figure 16.'):
            elements.append(make_paragraph(line.strip(), 'FigureCaption'))
            i += 1
            continue

        # Table caption line
        if line.strip().startswith('Table 16.') and '|' not in line:
