#!/usr/bin/env python3
"""
Create a Word .docx file for Chapter 3:
"Biomedical and Pharmacological Data Science".

Uses the raw-OOXML approach (python-docx is not available in this sandbox) and
embeds the generated PNG figures inline where "[Insert Figure N here]"
placeholders appear. Renders markdown headings, pipe tables and the reference
list. Reused from create_agentic_docx.py with updated paths/figure map.
"""
...
MD_FILE = '/projects/sandbox/AMMAN/Chapter_Biomedical_Pharmacological_Data_Science.md'
DOCX_FILE = '/projects/sandbox/AMMAN/Chapter_Biomedical_Pharmacological_Data_Science.docx'
FIG_DIR = '/projects/sandbox/AMMAN/biomed_figures'

FIGURE_FILES = {
    1: 'Figure_1_Data_Sources.png',
    2: 'Figure_2_Pipeline.png',
    3: 'Figure_3_Performance.png',
    4: 'Figure_4_Trust_Framework.png',
}
...
def md_to_body(md_text, image_rels):
    ...
    while i < len(lines):
        ...
        # Figure caption lines: "Figure N. ..."
        if re.match(r'^Figure \d', line.strip()):
            elements.append(make_paragraph(line.strip(), 'FigureCaption'))
            i += 1
            continue

        # Table caption lines: "Table N. ..." (not the pipe row)
